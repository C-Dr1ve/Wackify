...
local function updateColors(colors)
	...
	TokenColors.todo = (colors and colors.todo) or {Color = Color3.fromRGB(141, 118, 0), IsBold = false}
	TokenColors.link = (colors and colors.link) or {Color = Color3.fromRGB(11, 90, 175), IsUnderlined = true}
	TokenColors.custom = (colors and colors.custom) or {Color = Color3.fromRGB(253, 251, 172), IsBold = false}
